...
import { fetchLogin } from "@/components/store/slice/userSlice";
    ...
    <LoginContainer>
      <LoginCard>
        ...
        <SocialLoginContainer>
          <SocialLoginButton type="button" aria-label="Login with Google">
          ...
          <SocialLoginButton type="button" aria-label="Login with GitHub">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
